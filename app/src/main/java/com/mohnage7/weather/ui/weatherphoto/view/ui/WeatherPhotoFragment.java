...
import com.mohnage7.weather.ui.OnFragmentInteractionListener;
import com.mohnage7.weather.ui.weatherphoto.view.callback.WeatherPhotoHandler;
...
import static com.mohnage7.weather.ui.share.ui.ShareFragment.WEATHER_PHOTO_EXTRA;
import static com.mohnage7.weather.ui.weatherphoto.view.ui.LocationManager.REQUEST_CHECK_SETTINGS;
...
public class WeatherPhotoFragment extends Fragment implements WeatherPhotoHandler, LocationManagerInteraction {
    ...
    private void setViews(WeatherModel weatherModel) {
        ...
        binding.tempTv.setText(String.format("%s°", Math.round(weatherModel.getTemp())));
        binding.minMaxTv.setText(String.format("%s ° / %s °", Math.round(weatherModel.getMaxTemp()), Math.round(weatherModel.getMinTemp())));
    ...
    public void onResume() {
        super.onResume();
        mListener.setToolbarTitle(getString(R.string.new_photo));
